...
class BLSTM(torch.nn.Module):
    ...
    def forward(self, input):
        ...
        # recurrent = recurrent + input # add residual connection        
...
class Transition22(nn.Sequential):
    def __init__(self, num_input_features, num_output_features):
        ...
        self.add_module('pool', nn.MaxPool2d(kernel_size=2, stride=2))   #修改为maxPool AvgPool2d
...
class Transition21(nn.Sequential):
    def __init__(self, num_input_features, num_output_features):
        ...
        self.add_module('conv', nn.Conv2d(num_input_features, num_output_features,
                                          kernel_size=1, stride=1, bias=False))
        self.add_module('pool', nn.MaxPool2d(kernel_size=2, stride=(2, 1),padding=(0, 1)))   # AvgPool2d
...
class DenseNet_BLSTM_CTC_MODEL(torch.nn.Module):
    def __init__(self, growth_rate=32, block_config=(6, 12, 24, 16),
        ...
        self.RNN.add_module('BLSTM1', BLSTM(1024, 256, 256)) # 1024
    ...
    def forward(self, input):
        ...
        output = output.permute(2, 0, 1) # 15=W/8 1 1024
