...
if __name__ == '__main__':
    ...
    parser.add_argument('--arch', default='tsrn_tl_cascade', choices=['tsrn', 'bicubic', 'srcnn', 'vdsr', 'srres', 'esrgan', 'rdn',
    ...
    parser.add_argument('--test_data_dir', type=str, default='/home/tcs1/data1/dataset/textzoom/test/medium/', help='')
    ...
    opt = {  # 配置TPG参数
        ...
        "character": '-0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ' #"-0123456789abcdefghijklmnopqrstuvwxyz"
    }
